        ...
        notifications: {
            ...
            gmcRevisionReturn: {
                confirm: {
                    ...
                    message: 'Ариза ба ШИГ барои ислоҳ бармегардад. / Заявка будет возвращена в КУГ на доработку.',
                    consequence: 'Что произойдет: возврат на доработку. Маршрут: Комитет -> КУГ. Следующий статус: На доработке в КУГ.',
                    buttons: { cancel: 'Отмена', confirm: 'Да, вернуть в КУГ' }
                },
                success: {
                    title: 'Ба ШИГ баргардонда шуд / Возвращено в КУГ',
                    message: 'Что произошло: заявка возвращена в КУГ. Маршрут: Комитет -> КУГ. Следующий статус: На доработке в КУГ.'
                }
            },
            validation: {
                error: {
