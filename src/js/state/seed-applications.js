(function initSeedApplications() {
    ...
    window.seedApplications = [
        ...
        {
            id: '10004', name: 'Иванов Иван Иванович', sector: 'Хизматрасонӣ <span class="ru">/ Услуги</span>', amount: '8 000', date: '08.03.2026, 16:20', status: 'gmc_preparation', gmcEvaluation: perfGmc, auditLog: [
                ...
                { date: '08.03.2026, 16:20', actor: 'ШИГ / КУГ', action: 'Тасдиқ шуд, ба омодасозии реестр гузашт', actionRu: 'Одобрено КУГ, передано на подготовку реестра', color: 'emerald', icon: 'check' }
            ]
        },
        {
            id: '10035', name: 'Шарипова Лайло', sector: 'Хизматрасонӣ <span class="ru">/ Услуги</span>', amount: '9 500', date: '12.03.2026, 09:40', status: 'gmc_preparation', gmcEvaluation: perfGmc, auditLog: [
                ...
                { date: '12.03.2026, 09:40', actor: 'ШИГ / КУГ', action: 'Тасдиқ шуд, ба омодасозии реестр гузашт', actionRu: 'Одобрено КУГ, передано на подготовку реестра', color: 'emerald', icon: 'check' }
            ]
        },
        {
            id: '10031', name: 'Носирова Нигина', sector: 'Истеҳсолот <span class="ru">/ Производство</span>', amount: '16 000', date: '11.03.2026, 15:20', status: 'fac_revision', gmcEvaluation: perfGmc, auditLog: [
                ...
                { date: '10.03.2026, 14:00', actor: 'ШИГ / КУГ', action: 'Тасдиқ шуд, ба омодасозии реестр гузашт', actionRu: 'Одобрено КУГ, передано на подготовку реестра', color: 'emerald', icon: 'check' },
                { date: '11.03.2026, 15:20', actor: 'Кумита / Комитет', action: 'Рад шуд, ба мавқуф гузашт', actionRu: 'Отклонено, переведено в отложенные', color: 'amber', icon: 'alert-triangle', comment: 'Хавфи экологӣ вуҷуд дорад' }
            ]
        },
        {
        ...
        {
            id: '10013', name: 'Фотимаи Зариф', sector: 'Савдо <span class="ru">/ Торговля</span>', amount: '10 000', date: '01.03.2026, 14:00', status: 'approved', protocolId: 'СП-9001', gmcEvaluation: perfGmc, auditLog: [
                ...
                { date: '18.01.2026, 14:00', actor: 'ШИГ / КУГ', action: 'Тасдиқ шуд, ба омодасозии реестр гузашт', actionRu: 'Одобрено КУГ, передано на подготовку реестра', color: 'emerald', icon: 'check' },
                { date: '25.01.2026, 16:30', actor: 'ШИГ / КУГ', action: 'Баҳогузории иҷтимоӣ-экологӣ гузашт', actionRu: 'Социально-экологическая оценка пройдена', color: 'emerald', icon: 'check-circle' },
        ...
        {
            id: '10007', name: 'Бобоев Али', sector: 'Истеҳсолот <span class="ru">/ Производство</span>', amount: '15 000', date: '11.03.2026, 12:45', status: 'gmc_preparation', gmcEvaluation: perfGmc, auditLog: [
                ...
                { date: '03.03.2026, 14:15', actor: 'ШИГ / КУГ', action: 'Тасдиқ шуд, ба омодасозии реестр гузашт', actionRu: 'Одобрено КУГ, передано на подготовку реестра', color: 'emerald', icon: 'check' },
                { date: '11.03.2026, 12:45', actor: 'ШИГ / КУГ', action: 'Баҳогузории иҷтимоӣ-экологӣ гузашт', actionRu: 'Социально-экологическая оценка пройдена', color: 'emerald', icon: 'check-circle' }
            ]
        },
        {
            id: '10032', name: 'Қодиров Зафар', sector: 'Савдо <span class="ru">/ Торговля</span>', amount: '12 500', date: '12.03.2026, 08:45', status: 'gmc_preparation', gmcEvaluation: perfGmc, auditLog: [
                ...
                { date: '10.03.2026, 14:15', actor: 'ШИГ / КУГ', action: 'Тасдиқ шуд, ба омодасозии реестр гузашт', actionRu: 'Одобрено КУГ, передано на подготовку реестра', color: 'emerald', icon: 'check' },
                { date: '12.03.2026, 08:45', actor: 'ШИГ / КУГ', action: 'Баҳогузории иҷтимоӣ-экологӣ гузашт', actionRu: 'Социально-экологическая оценка пройдена', color: 'emerald', icon: 'check-circle' }
            ]
        },
        {
            id: '10022', name: 'Сайфуллоев Олим', sector: 'Хизматрасонӣ <span class="ru">/ Услуги</span>', amount: '8 500', date: '12.03.2026, 09:10', status: 'gmc_ready_for_registry', gmcEvaluation: perfGmc, auditLog: [
                ...
                { date: '07.03.2026, 14:15', actor: 'ШИГ / КУГ', action: 'Тасдиқ шуд, ба омодасозии реестр гузашт', actionRu: 'Одобрено КУГ, передано на подготовку реестра', color: 'emerald', icon: 'check' },
                { date: '10.03.2026, 12:45', actor: 'ШИГ / КУГ', action: 'Баҳогузории иҷтимоӣ-экологӣ гузашт', actionRu: 'Социально-экологическая оценка пройдена', color: 'emerald', icon: 'check-circle' },
        ...
        {
            id: '10017', name: 'Шарипов Сомон', sector: 'Хизматрасонӣ <span class="ru">/ Услуги</span>', amount: '11 000', date: '12.03.2026, 09:00', status: 'gmc_ready_for_registry', gmcEvaluation: perfGmc, auditLog: [
                ...
                { date: '03.03.2026, 10:00', actor: 'ШИГ / КУГ', action: 'Тасдиқ шуд, ба омодасозии реестр гузашт', actionRu: 'Одобрено КУГ, передано на подготовку реестра', color: 'emerald', icon: 'check' },
                { date: '08.03.2026, 14:00', actor: 'ШИГ / КУГ', action: 'Баҳогузории иҷтимоӣ-экологӣ гузашт', actionRu: 'Социально-экологическая оценка пройдена', color: 'emerald', icon: 'check-circle' },
        ...
        {
            id: '10040', name: 'Тоиров Бахтиёр', sector: 'Савдо <span class="ru">/ Торговля</span>', amount: '10 500', date: '12.03.2026, 10:00', status: 'com_review', gmcEvaluation: perfGmc, auditLog: [
                { date: '05.03.2026, 09:00', actor: 'Фасилитатор', action: 'Дархост бор карда шуд', actionRu: 'Заявка отправлена в КУГ', color: 'blue', icon: 'send' },
                { date: '06.03.2026, 10:00', actor: 'ШИГ / КУГ', action: 'Тасдиқ шуд, ба омодасозии реестр гузашт', actionRu: 'Одобрено КУГ, передано на подготовку реестра', color: 'emerald', icon: 'check' },
                { date: '08.03.2026, 14:00', actor: 'ШИГ / КУГ', action: 'Баҳогузории иҷтимоӣ-экологӣ гузашт', actionRu: 'Социально-экологическая оценка пройдена', color: 'emerald', icon: 'check-circle' },
    ...
    function buildReadyDocumentBundleForApproved(app, serial) {
        var baseDate = String(app.date || '01.03.2026, 10:00');
        var uploadedByRole = 'Фасилитатор';
        var uploadedByName = 'Фасилитатор';
        var appId = String(app.id || serial);
        ...
        return {
            ...
            wordVersions: [
                {
                    version: 1,
                    name: 'BusinessPlan_' + appId + '_V1.docx',
                    uploadedAt: baseDate,
            ...
            basePdf: {
                name: 'BusinessPlan_' + appId + '.pdf',
                uploadedAt: baseDate,
                uploadedByRole: uploadedByRole,
                uploadedByName: uploadedByName
            },
            basePhotos: [1, 2, 3, 4].map(function (slot) {
                return {
                    slot: slot,
                    name: 'Photo_' + appId + '_' + slot + '.jpg',
                    uploadedAt: baseDate,
                    uploadedByRole: uploadedByRole,
                    uploadedByName: uploadedByName
                };
    ...
    // Prepare at least 20 approved applications with full base document package
    // and pre-filled draft contract data, ready for facilitator contract generation.
    ...
    approvedForContractSeed.forEach(function (app, idx) {
        ...
        app.auditLog.push({
            ...
            actor: 'Система',
            action: 'Пакети ҳуҷҷатҳо барои шартнома омода аст',
            actionRu: 'Пакет документов для договора подготовлен',
            color: 'emerald',
            icon: 'file-check'
        });
    });
