...
flowchart TD
    ...
    subgraph "ШИГ"
        V4["Решение выбрано<br/>→ иначе уведомление 'Қарорро интихоб кунед'"]
...
| Данные бенефициара неполные (при выборе) | ⚠️ Inline (оранжевый) | `'⚠ Маълумоти бенефициар нопурра аст! / Данные бенефициара неполные! Нопурра / Неполное: Тамос / Контакты, РМА (ИНН), ...'` |
...
| Ситуация | Тип | Текст сообщения |
|----------|-----|----------------|
| Не выбрано решение | ⚠️ Toast (warning) | `'Қарорро интихоб кунед / Выберите решение'` |
...
| Возврат Фасилитатору без комментария | ⚠️ Toast (warning) | `'Лутфан эзоҳи бозгардониданро нависед! / Укажите комментарий для возврата!'` |
...
| Добавление в реестр (0 выбрано) | ⚠️ Toast (warning) | `'Ҳадди аққал як дархостро интихоб кунед / Выберите хотя бы одну заявку!'` |
...
| Ситуация | Тип | Текст сообщения |
|----------|-----|----------------|
| Не все обязательные поля заполнены | ⚠️ Toast (warning) | `'Лутфан ҳамаи майдонҳои ҳатмиро пур кунед! / Заполните все обязательные поля!'` |
