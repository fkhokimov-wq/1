...
| Нажатие «Создать» при hard block | 🛑 Alert | `'Эҷод манъ аст / Создание заблокировано: ...'` |
| Нажатие «Отправить в ШИГ» при hard block | 🛑 Alert | `'Эҷод ва ирсол манъ аст / Создание и отправка заблокированы: ...'` |
| Сектор или сумма не заполнены | ⚠️ Alert | `'Бахш ва маблағро пур кунед! / Заполните сектор и сумму!'` |
| Данные бенефициара неполные (при отправке) | 🛑 Alert | `'Маълумоти бенефициар нопурра аст! / Данные бенефициара неполные! Ирсол имконнопазир аст. / Отправка невозможна.'` |
| Данные бенефициара неполные (при выборе) | ⚠️ Inline (оранжевый) | `'⚠ Маълумоти бенефициар нопурра аст! / Данные бенефициара неполные! Нопурра / Неполное: поля'` |
...
| Ситуация | Тип | Текст сообщения |
|----------|-----|----------------|
| Не выбрано решение | ⚠️ Alert | `'Қарорро интихоб кунед / Выберите решение'` |
| Рекомендован в ГРП | ✅ Alert (info) | `'Тасдиқ шуд ва ба ГРП равон шуд. / Утверждено и направлено в ГРП.'` |
| Возвращён на доработку | 🔄 Alert (info) | `'Ба такмил баргардонида шуд. / Возвращено на доработку.'` |
| Отклонён | ❌ Alert (info) | `'Дархост рад карда шуд. / Заявка отклонена.'` |
| Возврат Фасилитатору без комментария | ⚠️ Alert | `'Лутфан эзоҳи бозгардониданро нависед! / Укажите комментарий для возврата!'` |
| Лимит доработок 3/3 → postponed | ⏸️ Alert | `'Лимити такмил (3/3) ба итмом расид. / Лимит доработок исчерпан. Дархост ба таъхир гузошта шуд. / Заявка отложена.'` |
| Добавление в реестр (0 выбрано) | ⚠️ Alert | `'Ҳадди аққал як дархостро интихоб кунед / Выберите хотя бы одну заявку!'` |

#### Решения ГРП (PIU)

| Ситуация | Тип | Текст сообщения |
|----------|-----|----------------|
| Возврат без комментария | ⚠️ Alert | `'Лутфан сабаби баргардониданро нависед! / Укажите причину возврата!'` |

#### Комитет (Committee)

| Ситуация | Тип | Текст сообщения |
|----------|-----|----------------|
| Не выбран реестр | ⚠️ Alert | `'Аввал рӯйхати лозимро интихоб кунед / Сначала выберите нужный список'` |
| Дата протокола не заполнена | ⚠️ Alert | `'Санаро интихоб кунед / Выберите дату'` |
...
| Список пуст | ⚠️ Alert | `'Рӯйхат холӣ аст / Список пуст'` |

#### Мониторинг

| Ситуация | Тип | Текст сообщения |
|----------|-----|----------------|
| Не все обязательные поля заполнены | ⚠️ Alert | `'Лутфан ҳамаи майдонҳои ҳатмиро пур кунед! / Заполните все обязательные поля!'` |
| Оборудование = "Продано" | 🔴 Inline + Alert | Красный блок: `'Огоҳӣ ба Админ фиристода мешавад! / Уведомление Админу!'` + alert: `'Огоҳинома ба Администратор фиристода шуд! / Уведомление отправлено Администратору!'` |
